...
const useSearchForm = ({
  ...
  const handleTextChange = (e) => {
    ...
    // DEBOUNCE: cancelar el timeout anterior, sirve para evitar que por cada tecla que se oprima
    // se renderice la pagina, con el DEBOUNCE se logra que despues de un tiempo se haga la busqueda
    ...
    timeoutId.current = setTimeout(() => {
      onTextFilter(text);
    }, 500); // normalmente va de 100 ms a 500 ms
  };
